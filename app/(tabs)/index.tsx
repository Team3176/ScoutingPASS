...
export default function PreMatchScreen() {
  ...
  useEffect(() => {
    try {
      ...
      setConfigError(
        "Failed to load configuration data. Please restart the app."
      );
    }
  }, []);
  ...
  const teamConfig = configJson.prematch?.find(
    (field: any) => field.code === "t"
  ) || { name: "Team Number" };
  const scouterConfig = configJson.prematch?.find(
    (field: any) => field.code === "s"
  ) || { name: "Scouter Name" };
  const robotConfig = configJson.prematch?.find(
    (field: any) => field.code === "r"
  );
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(value) =>
                  handleInputChange("matchNumber", value)
                }
            ...
            <View style={styles.inputGroup}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  setShowMatchLevelDropdown(!showMatchLevelDropdown)
                }
              >
                <Text style={{ color: "#000000" }}>
                  {scoutingData.matchLevel || "Select match level"}
                </Text>
              </TouchableOpacity>
              <Modal
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(value) =>
                  handleInputChange("scouterInitials", value)
                }
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>
                {robotConfig?.name || "Robot Position"}
              </Text>
              <View style={styles.robotSections}>
                <View style={styles.robotSection}>
                  <Text
                    style={[styles.robotSectionTitle, { color: "#FF0000" }]}
                  >
                    Red
                  </Text>
                ...
                <View style={styles.robotSection}>
                  <Text
                    style={[styles.robotSectionTitle, { color: "#0000FF" }]}
                  >
                    Blue
                  </Text>
                  <View style={styles.robotRadioGroup}>
