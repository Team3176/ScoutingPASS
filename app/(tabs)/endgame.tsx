...
import { StyleSheet, View as RNView, TouchableOpacity, TextInput, useColorScheme } from 'react-native';
...
const RadioButton: React.FC<RadioButtonProps> = ({ label, selected, onSelect, position }) => (
  <TouchableOpacity 
    style={[
      styles.radioButton,
...
export default function EndgameScreen() {
  ...
  const setClimbStatus = (key: 'deepClimbStatus' | 'shallowClimbStatus' | 'parkedStatus', status: 'not_attempted' | 'failed' | 'successful') => {
